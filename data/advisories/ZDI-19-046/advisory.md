# ZDI-19-046: Oracle VirtualBox svcGetBuffer Uninitialized Memory Information Disclosure Vulnerability

## Metadata

- **ZDI ID:** ZDI-19-046
- **ZDI-CAN:** ZDI-CAN-6904
- **Date:** 2019-01-17
- **CVE:** CVE-2019-2446
- **CVSS:** 5.5
...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-19-046/
## Vulnerability Details

This vulnerability allows local attackers to disclose sensitive information on vulnerable installations of Oracle VirtualBox. An attacker must first obtain the ability to execute low-privileged code on the target guest system in order to exploit this vulnerability. The specific flaw exists within the svcGetBuffer method. The issue results from the lack of proper initialization of memory prior to accessing it. An attacker can leverage this in conjunction with other vulnerabilities to execute code in the context of the hypervisor.
