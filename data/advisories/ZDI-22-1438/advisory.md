# ZDI-22-1438: Altair HyperView Player H3D File Parsing Improper Validation of Array Index Remote Code Execution Vulnerability

## Metadata

- **ZDI ID:** ZDI-22-1438
- **ZDI-CAN:** ZDI-CAN-15154
- **Date:** 2022-10-14
- **CVE:** CVE-2022-2951
- **CVSS:** 7.8
...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-22-1438/
## Vulnerability Details

This vulnerability allows remote attackers to execute arbitrary code on affected installations of Altair HyperView Player. User interaction is required to exploit this vulnerability in that the target must visit a malicious page or open a malicious file. The specific flaw exists within the parsing of H3D files. The issue results from the lack of proper validation of user-supplied data, which can result in a memory access past the end of an allocated array. An attacker can leverage this vulnerability to execute code in the context of the current process.
