...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-24-1729/
...
08/01/24 – ZDI reported the vulnerability to the vendor 08/01/24 – the vendor acknowledged the receipt of the report 09/11/24 - ZDI asked for updates 12/16/24 - ZDI notified the vendor of the intention to publish the case as a 0-day advisory Mitigation: Given the nature of the vulnerability, the only salient mitigation strategy is to restrict interaction with the application
