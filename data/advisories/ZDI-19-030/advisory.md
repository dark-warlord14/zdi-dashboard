# ZDI-19-030: Schneider Electric IIoT Monitor SettingMgmt upload Directory Traversal Remote Code Execution Vulnerability

## Metadata

- **ZDI ID:** ZDI-19-030
- **ZDI-CAN:** ZDI-CAN-7136
- **Date:** 2019-01-14
- **CVE:** CVE-2018-7836
- **CVSS:** 9.8
...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-19-030/
## Vulnerability Details

This vulnerability allows remote attackers to execute arbitrary code on vulnerable installations of Schneider Electric IIoT Monitor. Authentication is not required to exploit this vulnerability. The specific flaw exists within the processing of the upload method of the SettingMgmt servlet. The issue results from the lack of proper validation of a user-supplied path prior to using it in file operations. An attacker can leverage this vulnerability to execute code in the context of SYSTEM.
