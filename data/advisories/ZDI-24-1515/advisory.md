...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-24-1515/
...
09/13/24 – ZDI submitted the report to the vendor via a bug bounty platform 10/14/24 – the vendor rejected the vulnerability 11/06/24 – ZDI notified the vendor of the intention to publish the case as 0-day advisory -- Mitigation: Given the nature of the vulnerability, the only salient mitigation strategy is to restrict interaction with the application
