# ZDI-20-752: (0Day) CentOS Web Panel ajax_dashboard service_start Command Injection Remote Code Execution Vulnerability

## Metadata

- **ZDI ID:** ZDI-20-752
- **ZDI-CAN:** ZDI-CAN-9719
- **Date:** 2020-06-25
- **CVE:** CVE-2020-15435
- **CVSS:** 9.8
...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-20-752/
## Vulnerability Details

This vulnerability allows remote attackers to execute arbitrary code on affected installations of CentOS Web Panel. Authentication is not required to exploit this vulnerability. The specific flaw exists within ajax_dashboard.php. When parsing the service_start parameter, the process does not properly validate a user-supplied string before using it to execute a system call. An attacker can leverage this vulnerability to execute code in the context of root.
