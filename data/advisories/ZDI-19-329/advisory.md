# ZDI-19-329: Advantech WebAccess Client upandpr sprintf Stack-based Buffer Overflow Remote Code Execution Vulnerability

## Metadata

- **ZDI ID:** ZDI-19-329
- **ZDI-CAN:** ZDI-CAN-7924
- **Date:** 2019-04-02
- **CVE:** CVE-2019-6550
- **CVSS:** 9.8
...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-19-329/
## Vulnerability Details

This vulnerability allows remote attackers to execute arbitrary code on vulnerable installations of Advantech WebAccess Client. Authentication is not required to exploit this vulnerability. The specific flaw exists within a sprintf call in upandpr.exe, which is accessed through the 0x2711 IOCTL in the webvrpcs process. The issue results from the lack of proper validation of the length of user-supplied data prior to copying it to a fixed-length stack-based buffer. An attacker can leverage this vulnerability to execute code in the context of Administrator.
