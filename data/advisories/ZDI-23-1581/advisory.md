...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-23-1581/
...
09/08/23 – ZDI reported the vulnerability to the vendor. 09/11/23 – The vendor acknowledged the report. 09/27/23 – The vendor states that the vulnerability does not require immediate servicing. 09/29/23 – ZDI informed the vendor that we are publishing this case as a zero-day advisory in the coming weeks. 11/01/02 – ZDI Informed the vendor that we intend to publish on 11/02/2023. -- Mitigation: Given the nature of the vulnerability, the only salient mitigation strategy is to restrict interaction with the application.
