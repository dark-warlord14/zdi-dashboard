# ZDI-25-802: (0Day) (Pwn2Own) Kenwood DMX958XR ReadMVGImage Command Injection Remote Code Execution Vulnerability

## Metadata

- **ZDI ID:** ZDI-25-802
- **ZDI-CAN:** ZDI-CAN-26313
- **Date:** 2025-08-05
- **CVE:** CVE-2025-8654
- **CVSS:** 8.8
...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-25-802/
## Vulnerability Details

This vulnerability allows network-adjacent attackers to execute arbitrary code on affected installations of Kenwood DMX958XR devices. Authentication is not required to exploit this vulnerability. The specific flaw exists within the ReadMVGImage function. The issue results from the lack of proper validation of a user-supplied string before using it to execute a system call. An attacker can leverage this vulnerability to execute code in the context of root.
