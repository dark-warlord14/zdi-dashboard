# ZDI-19-386: Oracle VirtualBox crServerDispatchGetLightiv Out-Of-Bounds Read Information Disclosure Vulnerability

## Metadata

- **ZDI ID:** ZDI-19-386
- **ZDI-CAN:** ZDI-CAN-7982
- **Date:** 2019-04-17
- **CVE:** CVE-2019-2574
- **CVSS:** 6.5
...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-19-386/
## Vulnerability Details

This vulnerability allows local attackers to disclose sensitive information on vulnerable installations of Oracle VirtualBox. An attacker must first obtain the ability to execute low-privileged code on the target guest system in order to exploit this vulnerability. The specific flaw exists within the crServerDispatchGetLightiv method. The issue results from the lack of proper validation of user-supplied data, which can result in a read past the end of an allocated object. An attacker can leverage this in conjunction with other vulnerabilities to execute code in the context of the hypervisor.
