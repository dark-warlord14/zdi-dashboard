...
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-24-1275/
...
08/22/24 – ZDI requested the vendor’s PSIRT contacts 08/30/24 – ZDI asked for updates 09/11/24 – ZDI notified the vendor of the intention to publish the case as 0-day advisory -- Mitigation: Given the nature of the vulnerability, the only salient mitigation strategy is to restrict interaction with the application
