# ZDI-22-1121: ManageEngine NetFlow Analyzer getUserAPIKey Authentication Bypass Vulnerability

## Metadata

- **ZDI ID:** ZDI-22-1121
- **ZDI-CAN:** ZDI-CAN-18089
- **Date:** 2022-08-18
- **CVE:** CVE-2022-36923
- **CVSS:** 9.4
...
- **Credit:** Anonymous
- **Source:** https://www.zerodayinitiative.com/advisories/ZDI-22-1121/
## Vulnerability Details

This vulnerability allows remote attackers to bypass authentication on affected installations of ManageEngine NetFlow Analyzer. Authentication is not required to exploit this vulnerability. The specific flaw exists within the getUserAPIKey function. The issue results from the lack of authentication prior to allowing access to functionality. An attacker can leverage this vulnerability to bypass authentication on the system.
